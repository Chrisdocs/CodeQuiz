...
answers: { a: "innerDIV", b: "innerHTML", c: "addHTML", d: "addDIV" },
correctAnswer: "b",
},
...
// insert the previous answer into the <p> element in the current question
...
.addEventListener("click", function clickedA() {
    // console.log("clicked");
...
.addEventListener("click", function clickedB() {
...
.addEventListener("click", function clickedC() {
...
.addEventListener("click", function clickedD() {
...
document
.getElementById("stbtn")
.addEventListener("click", function startQuizButton() {
var divMain = document.getElementById("maindiv");
